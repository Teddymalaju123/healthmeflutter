...
import '../ui_view/area_list_vie2.dart';
...
class TrainingScreen2 extends StatefulWidget {
  const TrainingScreen2({Key? key, this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _TrainingScreen2State createState() => _TrainingScreen2State();
}
